async function mostrarInformacion() {
  ...
  try {
    ...
    document.getElementById("m-barra").textContent = usuario.usuario[0].NOMBRE + " " + usuario.usuario[0].APELLIDO;   
    sessionStorage.setItem("NOMBRE_USER", textContent = usuario.usuario[0].NOMBRE) 
  } catch (error) {
    console.log("error");
  }
}
